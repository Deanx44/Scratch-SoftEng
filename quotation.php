...
<body>
            ...
            <div class="row wrap" id="ticketed">
                <div class="col body">
                    ...
                    <div class="row body">
                        ...
                        <div class="row w-100">
                            <?php
                            $quotation = "SELECT * FROM quotation WHERE user_id = '$userid' ORDER BY id DESC";
                                        ...
                                        <div class="row w-100">
                                            ...
                                            <div class="col-4 mt-5">
                                                ...
                                                <select name="branch" class="form-control" id="branch" required>
                                                    <option selected>Cuyo</option>
                                                    <option>Amanpulo</option>
                                                </select>
                                            </div>
    ...
    if (isset($_GET['submit'])) {
        ...
        $query = "INSERT INTO quotation(title, origin, branch, destination, date, days, pax, email, status, user_id) 
